#ifndef PANELWCSUMMARYREPORTMODEL_H
#define PANELWCSUMMARYREPORTMODEL_H
#include <QObject>
#include <QDebug>

#include "source/service/coreservice.h"

class PanelWCSummaryReportModel : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit PanelWCSummaryReportModel(QObject *parent = nullptr):QObject(parent)
    {
        qDebug() << "[PanelWCSummaryReportModel] create instance";

        mpCoreService = CoreService::getInstance();
    }
};
#endif // PANELWCSUMMARYREPORTMODEL_H
