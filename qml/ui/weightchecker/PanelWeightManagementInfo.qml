...
import PanelWeightManagementInfoModel 1.0
...
Rectangle {
    ...
    PanelWeightManagementInfoModel
    {
        id : model
    }
    ...
    PopupWeightManagerInfoEditor{
        ...
        onSignalEventChagnedValue: {
            model.onCommandSetManagementInfo(dNum, dName, company, department, position, name)
        }
    }
