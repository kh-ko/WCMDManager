...
Flow {
    ...
    property PanelWCReportModel dailyModel : null
    ...
    function refresh()
    {
        console.debug("[PanelWCReportContainer::refresh]")
        ...
        dailyModel = containerModel.onCommandGetSelDayModel();

        if(dailyModel === null)
            return;

        summaryPage.createObject(containerPage, {"containerModel":containerModel, "reportModel":dailyModel, "productModel":dailyModel.onCommandGetProductModel(containerModel.mSelPSeq)})
        //histogramPage.createObject(containerPage, {"containerModel":containerModel, "reportModel":dailyModel, "pageIdx":i})
        //trendsPage.createObject(containerPage, {"containerModel":containerModel, "reportModel":dailyModel, "pageIdx":i})
    }
