...
Window{
    ...
    title : qsTr("Metal detector checkup report")
    ...
    {
        dailyReportContainer.setData(reportContainerModel, reportContainerModel.onCommandGetDailyListReport(idx))
    }
    ...
    Component.onCompleted: {console.debug("PanelMDReportWindow:Create")}
    Component.onDestruction:{console.debug("PanelMDReportWindow:Destroy")}
            ...
            ColumnLayout{
                ...
                PanelMDCheckReportContainer{
                    ...
                    onSignalEventDeleteRow : {
                        reportContainerModel.onCommandRemoveRow(leftMenu.getSelectedDateIdx(), pageIdx, rowIdxInPage)
                        setDailyReport(leftMenu.getSelectedDateIdx())
                    }
                }
            }
        }
